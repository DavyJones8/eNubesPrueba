	...
	public function create_user()
	{
		...
		if ($this->form_validation->run() === TRUE && $flag_captcha && $this->ion_auth->register($identity, $password, $email, $additional_data))
		{
			...
			$config = Array(    
				...
				'smtp_host' => 'enubesprueba.ignaciovalero.es',
	
				'smtp_port' => 465,
	
				'smtp_user' => 'noreply@enubesprueba.ignaciovalero.es',
	
				'smtp_pass' => 'eNubes_2020',
			...
			$this->email->from('noreply@enubesnews.com', 'No reply');
